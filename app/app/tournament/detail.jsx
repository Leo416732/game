        ...
        <Flex justify="space-between" wrap="wrap" gap={["4", "4", 0, 0]}>
          ...
          >
            ...
            <Stack my={["3", "3", 0, 0]}>
              ...
              <Text color="white">
                <b className="text-[#deff1a]">1.</b> Begin by navigating to the
                event you want to participate in.
                <br />
                <b className="text-[#deff1a]">2.</b> In the "Life" section,
                input the quantity of lives you want to purchase, ensuring it
                falls within the range of 1 to 100.
                <br />
                <b className="text-[#deff1a]">3.</b> When ready, click on "Buy
                Life"
                <br /> <b className="text-[#deff1a]">4.</b> Carefully review the
                MetaMask pop-up window, ensuring your agreement with the
                associated fees for acquiring Matic. If in agreement, click
                "Confirm." <br />
                <b className="text-[#deff1a]">5.</b> Following the confirmation,
